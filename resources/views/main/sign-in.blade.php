...
<!-- Mirrored from pixner.net/sbidu/main/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Jan 2025 05:15:26 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="hero-section">
        ...
        <div class="bg_img hero-bg bottom_center" data-background="{{URL::TO('main/images/banner/hero-bg.png')}}"></div>
    </div>
                    ...
                    <div class="col-sm-6 col-lg-3" data-aos="fade-down" data-aos-duration="1800">
                        <div class="footer-widget widget-follow">
                            ...
                            <ul class="links-list">
                                ...
                                <li>
                                    <a href="#0"><i class="fas fa-envelope-open-text"></i><span class="__cf_email__" data-cfemail="8ae2efe6facaefe4ede5fee2efe7efa4e9e5e7">[email&#160;protected]</span></a>
                                </li>
                                <li>
